...
기존 `AHRS.c`에 구현되어 있던 쿼터니언 기반 알고리즘은 다음과 같은 이유로 실제 비행에 부적합했습니다.
...
* **결과:** 자이로의 '빠릿함'과 가속도계의 '수평 유지 능력'을 결합하여 진동 상황에서도 안정적인 자세 추정이 가능해졌습니다.

### 1.3 AHRS 추가 개선 사항 (Anti-Drift Logic)
지자계 없이 Rate 제어를 수행하기 위해 **센서 데이터 전처리(Pre-processing)** 과정을 대폭 강화했습니다.
...
* **효과:** 이륙 직전 기체가 기울어져 있어도 I-term이 쌓이지 않아, 스로틀을 올리는 순간 급격하게 뒤집히는 사고를 예방합니다.
