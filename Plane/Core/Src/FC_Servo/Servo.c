...
#define MAX_YAW_RATE_RAD_S    (0.0f)   /* yaw는 보통 roll/pitch보다 낮게 */
...
#define KD_ROLL_US_PER_RAD_S   (0.0f)

#define KP_PITCH_US_PER_RAD_S  (30.0f)
#define KI_PITCH_US_PER_RAD_S  (0.0f)
#define KD_PITCH_US_PER_RAD_S  (0.0f)

#define KP_YAW_US_PER_RAD_S    (0.0f)
...
//오차 계산
    ...
    sp_roll_test = sp_roll;
    sp_pitch_test = sp_pitch;
// 여기서부터 각속도 pid
    /* 측정 rate */
